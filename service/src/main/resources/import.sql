...
----------------------------------------------------------------
INSERT INTO PERMISSAO(ID, NOME, DESCRICAO, DEPENDENCIA_ID) VALUES (1, 'ROLE_USUARIO_LOGADO_PAINEL_ADMIN', 'Login no painel administrativo', null); 
INSERT INTO PERMISSAO(ID, NOME, DESCRICAO, DEPENDENCIA_ID) VALUES (2, 'ROLE_CAD_USUARIO', 'Cadastrar novos usuários', null);
INSERT INTO PERMISSAO(ID, NOME, DESCRICAO, DEPENDENCIA_ID) VALUES (3, 'ROLE_CONS_USUARIO', 'Consultar usuários', null);
INSERT INTO PERMISSAO(ID, NOME, DESCRICAO, DEPENDENCIA_ID) VALUES (4, 'ROLE_EDT_USUARIO', 'Editar usuários existentes', 3);
INSERT INTO PERMISSAO(ID, NOME, DESCRICAO, DEPENDENCIA_ID) VALUES (5, 'ROLE_BLOQ_USUARIO', 'Bloquear usuários', 3);
INSERT INTO PERMISSAO(ID, NOME, DESCRICAO, DEPENDENCIA_ID) VALUES (6, 'ROLE_CAD_ATIVIDADE', 'Agendar atividade', null);
