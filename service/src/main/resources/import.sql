...
INSERT INTO USUARIO_SISTEMA(ID, LOGIN, SENHA_APLICACAO, DATA_CADASTRO, EMAIL, NOME, IND_ATIVO) VALUES (3, 'bruna', 'a3d4a413a3f981422388a46cbf1292fb', NOW(), 'fulano@gmail.com', 'Otávio Felipe do Prado', false);
INSERT INTO USUARIO_SISTEMA(ID, LOGIN, SENHA_APLICACAO, DATA_CADASTRO, EMAIL, NOME, IND_ATIVO) VALUES (4, 'rafaela', 'a3d4a413a3f981422388a46cbf1292fb', NOW(), 'fulano@gmail.com', 'Otávio Felipe do Prado', false);
INSERT INTO USUARIO_SISTEMA(ID, LOGIN, SENHA_APLICACAO, DATA_CADASTRO, EMAIL, NOME, IND_ATIVO) VALUES (5, 'pedro', 'a3d4a413a3f981422388a46cbf1292fb', NOW(), 'fulano@gmail.com', 'Otávio Felipe do Prado', false);
INSERT INTO USUARIO_SISTEMA(ID, LOGIN, SENHA_APLICACAO, DATA_CADASTRO, EMAIL, NOME, IND_ATIVO) VALUES (6, 'joao', 'a3d4a413a3f981422388a46cbf1292fb', NOW(), 'fulano@gmail.com', 'Otávio Felipe do Prado', true);
INSERT INTO USUARIO_SISTEMA(ID, LOGIN, SENHA_APLICACAO, DATA_CADASTRO, EMAIL, NOME, IND_ATIVO) VALUES (7, 'marcelo', 'a3d4a413a3f981422388a46cbf1292fb', NOW(), 'fulano@gmail.com', 'Otávio Felipe do Prado', true);
INSERT INTO USUARIO_SISTEMA(ID, LOGIN, SENHA_APLICACAO, DATA_CADASTRO, EMAIL, NOME, IND_ATIVO) VALUES (8, 'silvia', 'a3d4a413a3f981422388a46cbf1292fb', NOW(), 'fulano@gmail.com', 'Otávio Felipe do Prado', true);
INSERT INTO USUARIO_SISTEMA(ID, LOGIN, SENHA_APLICACAO, DATA_CADASTRO, EMAIL, NOME, IND_ATIVO) VALUES (9, 'roberto', 'a3d4a413a3f981422388a46cbf1292fb', NOW(), 'fulano@gmail.com', 'Otávio Felipe do Prado', true);
INSERT INTO USUARIO_SISTEMA(ID, LOGIN, SENHA_APLICACAO, DATA_CADASTRO, EMAIL, NOME, IND_ATIVO) VALUES (10, 'jose', 'a3d4a413a3f981422388a46cbf1292fb', NOW(), 'fulano@gmail.com', 'Otávio Felipe do Prado', true);
...
INSERT INTO USUARIO_SISTEMA_PERFIL(USUARIO_SISTEMA_ID, PERFIL_ID) VALUES (2, 3);
...
INSERT INTO USUARIO_SISTEMA_PERFIL(USUARIO_SISTEMA_ID, PERFIL_ID) VALUES (1, 9);
INSERT INTO USUARIO_SISTEMA_PERFIL(USUARIO_SISTEMA_ID, PERFIL_ID) VALUES (2, 9);
INSERT INTO USUARIO_SISTEMA_PERFIL(USUARIO_SISTEMA_ID, PERFIL_ID) VALUES (1, 10);
INSERT INTO USUARIO_SISTEMA_PERFIL(USUARIO_SISTEMA_ID, PERFIL_ID) VALUES (2, 10);
